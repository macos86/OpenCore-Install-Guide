...
* Mancanti [kernel patches](https://github.com/AMD-OSX/AMD_Vanilla)(si applica solo alle CPU AMD, assicurati che siano patch OpenCore e non Clover. Clover usa `MatchOS` mentre OpenCore ha`MinKernel` e `Maxkernel`)
...
* Se stai superando il limite di 15 porte necessiti di [Mappare le USB](/OpenCore-Post-Install/usb/)
  * Un altro problema può essere che un determinato firmware non passerà la proprietà USB a MacOS
    * `UEFI -> Quirks -> ReleaseUsbOwnership -> True`
    * Anche abilitare ECHI/XHCI Handoff nel BIOS può risolvere
* A volte, se l'USB è collegato a una porta 3.x, collegarlo a una porta 2.0 può correggere questo errore e viceversa.
...
* Se XLNCUSBFix non funziona ancora, prova quanto segue, assieme a XLNCUSBFix:
...
* L'ultima risorsa è provare invece [FakeSMC](https://github.com/CloverHackyColor/FakeSMC3_with_plugins), **non abilitare contemporaneamente VirtualSMC e FakeSMC**

...
| SMBIOS | Hardware |
| :--- | :--- |
| iMac18,1 | Utilizzato per Computer che utilizzano l'iGPU  per gestire un display |
| iMac18,3 | Utilizzato per Computer che utilizzano dGPU per gestire un display, e la iGPU solo per computazione |

...
* **ScanPolicy**: `0`
  * `0` consente di vedere tutte le unità disponibili, fare riferimento alla sezione [Security (EN)](/OpenCore-Post-Install/universal/security.html) per ulteriori dettagli. **Non avvierà i dispositivi USB con l'impostazione predefinita**
